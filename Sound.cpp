...
void Sound::Update()
{
	if (isUpdate)
	{
		...
		for (int i = 0; i < enemy->size(); ++i) {
			...
			//if (enemyState == EnemyAra::State::neutral || enemyState == EnemyAra::State::wait) { (*enemy)[i]->SetState(EnemyAra::State::cringe); } //í èÌÅAë“ã@èÛë‘ÇÃìGÇ…ÇÃÇ›ÉCÉWÉPèÛë‘Çïtó^Ç∑ÇÈ
...
//ìGÇ™Ç¢Ç∂ÇØèÛë‘Ç…Ç»Ç¡ÇΩÇÁí èÌéûÇÃâπÇí‚é~Ç∑ÇÈ
//ìGÇ™Ç‚ÇÁÇÍèÛë‘Ç…Ç»Ç¡ÇΩÇÁÇ¢Ç∂ÇØèÛë‘éûÇÃâπÇí‚é~Ç∑ÇÈ
